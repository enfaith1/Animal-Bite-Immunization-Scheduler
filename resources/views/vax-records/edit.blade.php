                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date_of_exposure" class="form-control rounded-3 @error('date_of_exposure') is-invalid @enderror" value="{{ old('date_of_exposure', $vaxRecord->date_of_exposure) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="exposure_type" class="form-control rounded-3 @error('exposure_type') is-invalid @enderror" value="{{ old('exposure_type', $vaxRecord->exposure_type) }}" placeholder="e.g., Bite, Scratch, Lick" required>
                                    @error('exposure_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="animal_condition" class="form-select rounded-3 @error('animal_condition') is-invalid @enderror" required>
                                        <option value="Healthy" {{ old('animal_condition', $vaxRecord->animal_condition) == 'Healthy' ? 'selected' : '' }}>Healthy</option>
                                        <option value="Sick" {{ old('animal_condition', $vaxRecord->animal_condition) == 'Sick' ? 'selected' : '' }}>Sick</option>
                                        <option value="Lost" {{ old('animal_condition', $vaxRecord->animal_condition) == 'Lost' ? 'selected' : '' }}>Lost</option>
                                        <option value="Dead" {{ old('animal_condition', $vaxRecord->animal_condition) == 'Dead' ? 'selected' : '' }}>Dead</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="rig_brand" class="form-control rounded-3" value="{{ old('rig_brand', $vaxRecord->rig_brand) }}" placeholder="Rabies Immunoglobulin brand">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date_of_visit" class="form-control rounded-3 @error('date_of_visit') is-invalid @enderror" value="{{ old('date_of_visit', $vaxRecord->date_of_visit) }}" required>
                                    @error('date_of_visit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="animal_type" class="form-select rounded-3 @error('animal_type') is-invalid @enderror" required>
                                        <option value="">Select Animal</option>
                                        <option value="Dog" {{ old('animal_type', $vaxRecord->animal_type) == 'Dog' ? 'selected' : '' }}>Dog</option>
                                        <option value="Cat" {{ old('animal_type', $vaxRecord->animal_type) == 'Cat' ? 'selected' : '' }}>Cat</option>
                                        <option value="Bat" {{ old('animal_type', $vaxRecord->animal_type) == 'Bat' ? 'selected' : '' }}>Bat</option>
                                        <option value="Monkey" {{ old('animal_type', $vaxRecord->animal_type) == 'Monkey' ? 'selected' : '' }}>Monkey</option>
                                        <option value="Rat" {{ old('animal_type', $vaxRecord->animal_type) == 'Rat' ? 'selected' : '' }}>Rat</option>
                                        <option value="Other" {{ old('animal_type', $vaxRecord->animal_type) == 'Other' ? 'selected' : '' }}>Other</option>
                                    </select>
                                    @error('animal_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="exposure_category" class="form-select rounded-3 @error('exposure_category') is-invalid @enderror" required>
                                        ...
                                        <option value="I" {{ old('exposure_category', $vaxRecord->exposure_category) == 'I' ? 'selected' : '' }}>Category I - Touching/feeding animals, intact skin</option>
                                        <option value="II" {{ old('exposure_category', $vaxRecord->exposure_category) == 'II' ? 'selected' : '' }}>Category II - Nibbling uncovered skin, minor scratches</option>
                                        <option value="III" {{ old('exposure_category', $vaxRecord->exposure_category) == 'III' ? 'selected' : '' }}>Category III - Transdermal bites, scratches, contamination of mucous membrane</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tetanus_brand" class="form-control rounded-3" value="{{ old('tetanus_brand', $vaxRecord->tetanus_brand) }}" placeholder="Tetanus vaccine brand">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="remarks" class="form-control rounded-3" rows="3" placeholder="Additional notes...">{{ old('remarks', $vaxRecord->remarks) }}</textarea>
                                </div>
                            </div>
                        </div>
