                                    ...
                                    @forelse($patients as $patient)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small class="text-muted"><i class="fas fa-map-marker-alt me-1"
                                                        style="font-size: 10px;"></i>
                                                    {{ Str::limit($patient->address, 40) }}</small>
                                            </td>
                                            <td>
                                                <i class="fas fa-phone me-1" style="color: #9EB698;"></i>
                                                {{ $patient->contact_num }}
                                            </td>
                                            <td>
                                                <i class="fas fa-envelope me-1" style="color: #9EB698;"></i>
                                                {{ Str::limit($patient->email, 25) }}
                                            </td>
                                            <td>
                                                <i class="fas fa-phone-alt me-1" style="color: #9EB698;"></i>
                                                {{ $patient->emergency_num }}
                                            </td>
                                            <td class="text-center">
                                                <a href="{{ route('patients.show', $patient) }}"
                                                    class="btn btn-sm btn-primary-custom"
                                                    style="padding: 6px 12px; border-radius: 8px; margin: 0 3px;">
