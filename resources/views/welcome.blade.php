        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('show.login') }}">
                                <i class="fas fa-sign-in-alt me-1"></i> Login
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('show.register') }}">
                                <i class="fas fa-user-plus me-1"></i> Register
                            </a>
                        </li>
                    @endguest
                    
                    <!-- Show Patients and Logout when logged in -->
                    @auth
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <form method="POST" action="{{ route('logout') }}" class="d-inline">
                                @csrf
                                <button type="submit" class="theme-toggle-btn" style="background: rgba(220, 53, 69, 0.2);">
